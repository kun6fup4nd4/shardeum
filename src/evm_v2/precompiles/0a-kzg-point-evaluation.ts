...
if (opts.data.length !== 192) return EvmErrorResult(new EvmError(ERROR.INVALID_INPUT_LENGTH), opts.gasLimit);
...
if (res === false) return EvmErrorResult(new EvmError(ERROR.INVALID_PROOF), opts.gasLimit);
    }
    catch (err: any) {
