...
if (chargeGas) return common.param('gasPrices', 'coldaccountaccess');
        // Warm: (selfdestruct beneficiary address reads are not charged when warm)
    }
else if (chargeGas && !isSelfdestructOrAuthcall) return common.param('gasPrices', 'warmstorageread');
return BigInt(0);
}
/**
...
else if (!isSstore) return common.param('gasPrices', 'warmstorageread');
return BigInt(0);
}
/**
