...
if (minimumVersion === testVersion) return true;
...
if (majorityCount > totalResults / 2) return majorityResult;
else return null;
}
...
if (!comparePropertiesTypes(A[key], B[key])) return false;
else 
