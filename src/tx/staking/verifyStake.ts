...
if (doesNominatorHaveTicketTypeResponse.enabled && !doesNominatorHaveTicketTypeResponse.success) return {
...
if (nominatorAccount.operatorAccountInfo.nominee.toLowerCase() !== stakeCoinsTx.nominee.toLowerCase()) return {
                    success: false,
...
if (timeSinceLastStake < stakeLockTime) return {
            unlocked: false,
...
if (timeSinceSyncing < stakeLockTime) return {
                unlocked: false,
...
if (timeSinceActive < stakeLockTime) return {
            unlocked: false,
...
if (timeSinceInactive < stakeLockTime) return {
            unlocked: false,
